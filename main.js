...
eval("var button = document.querySelector('.toggle-button');\nvar popover = document.createElement('div');\npopover.classList = 'popover hidden';\npopover.innerHTML = \"\\n  <h1 class=\\\"popover-title\\\">Popover title</h1>\\n  <p class=\\\"popover-content\\\">And here's some amazing content. It's very engaging. Right?</p>\";\nbutton.offsetParent.appendChild(popover);\npopover.style.right = \"\".concat(button.offsetLeft - (popover.offsetWidth - button.offsetWidth) / 2, \"px\");\npopover.style.bottom = \"\".concat(button.offsetTop + popover.offsetHeight + button.offsetHeight, \"px\");\nbutton.addEventListener('click', function () {\n  popover.classList.toggle('hidden');\n});\n\n//# sourceURL=webpack://ahj-hw-2.1-forms-popovers/./src/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://ahj-hw-2.1-forms-popovers/./src/css/style.css?");
